...
o	prefLabel: Bevorzugte, offizielle Bezeichnung des Schulfaches,
o	altLabel: Alternative, inoffizielle Bezeichnungen des Schulfaches und Slangnamen sowie Abkürzungen,
o	definition/description: Inhaltliche Erläuterung des Schulfaches, 
o	scopeNote: Hinweise zur Unterrichtssprache.
•	Hierarchische und strukturelle Verknüpfung:
o	broader: Einordnung in Wissenschaftsbereiche, z. B. Naturwissenschaften, 
o	inScheme, hasTopConcept, topConceptOf: Technische Einbindung in das Gesamtschema.
•	Metadaten:
o	publisher: Herausgeber (Deutsche Schule Helsinki), 
o	modified: Letztes Änderungsdatum.
